...
> - Cluster **Via Francigena** 3 spoke; **arrivi** completati; **Tuscia** rafforzata; **stagionali** da "solo estate" a 5 pagine; **esperienziali** nuovo blocco. Totali aggiornati sotto. Prossimo sprint esecutivo proposto: **E** (espansione pagine concise).
