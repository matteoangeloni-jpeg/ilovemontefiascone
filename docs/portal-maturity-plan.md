...
| Stagionali | debole | solo estate | `montefiascone-primavera/-autunno-vendemmia/-inverno-natale` | P2 | basso | |
...
## 9. Pagine deboli (per profondità, incl. chrome)
...
- Pagine: `montefiascone-primavera`, `montefiascone-autunno-vendemmia`, `montefiascone-inverno-natale`, `spiagge-famiglie-lago`, `bambini-montefiascone-pioggia`, `dove-vedere-tramonto-lago`, `esperienze-enogastronomiche`, `cosa-fare-montefiascone-pioggia`, `weekend-romantico`, `prodotti-da-acquistare`.
- SEO medio/alto, GEO medio. Rischio: basso/medio. NON: date eventi certe.

### Sprint E — espansione pagine concise
- Obiettivo: portare le pagine §9/§10 a maggiore profondità con sezioni utili (no filler).
- File: le ~12 pagine concise. SEO medio, GEO alto (più dati estraibili). Rischio: basso (solo fatti verificati). NON: gonfiare, inventare.
