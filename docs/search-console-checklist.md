# Search Console Checklist â€” ilovemontefiascone.com (IT)
...
Property URL: `https://www.ilovemontefiascone.com/` Â· Sitemap: `https://www.ilovemontefiascone.com/sitemap.xml` (index â†’ `sitemap-it.xml`, 48 URLs).
...
- [ ] Confirm sitemap status = *Success* and "Discovered URLs" â‰ˆ 48.
...
- [ ] Check **excluded pages**: privacy, cookie, 404, offline should be *Excluded by 'noindex'* â€” this is expected/correct.
...
- [ ] Pages **discovered / crawled** (Pages report â†’ growth in "Crawled").
- [ ] **404 errors** (Pages â†’ Not found): expect none for internal URLs.
...
- [ ] **Impressions** > 0 for brand and core terms (Montefiascone, Lago di Bolsenaâ€¦).
...
- [ ] **Low-CTR** pages with good impressions â†’ review title/meta.

## 5. Checks at 30 days
- [ ] Top **pages by clicks/impressions**.
- [ ] **Emerging queries** â†’ content opportunities.
- [ ] Pages to **expand** (high impressions, low position).
- [ ] Pages still **not indexed** â†’ investigate (thin? duplicate? internal links?).
