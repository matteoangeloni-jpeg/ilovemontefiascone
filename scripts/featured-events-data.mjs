...
export const FEATURED_EVENT_CANDIDATES = [
  ...
  },
  {
    ...
    teaser: [
      "Il cartellone lo presenta come festival culturale per parlare di grandi temi con personaggi del mondo culturale e dello spettacolo.",
      "Programma, orari e dettagli operativi possono essere aggiornati dagli organizzatori: verifica sempre i canali ufficiali prima della visita.",
    ],
    facts: [
      ["Date 2026", "16-19 luglio"],
      ["Tema", "grandi temi culturali"],
      ["Contesto", "paesaggio di Montefiascone"],
    ],
    image: {
      jpg: "/media/hero-rocca-dei-papi-1600.jpg",
      webp: "/media/hero-rocca-dei-papi-1600.webp",
  ...
  },
  {
    ...
    dateLabel: "19 e 20 luglio 2026",
    teaser: [
      "Il cartellone indica festeggiamenti in onore della Patrona Santa Margherita, tra cattedrale e centro storico.",
      "Programma, orari e dettagli operativi possono essere aggiornati dagli organizzatori: verifica sempre i canali ufficiali prima della visita.",
    ],
    facts: [
      ["Date 2026", "19-20 luglio"],
      ["Ricorrenza", "patrona Santa Margherita"],
      ["Luogo simbolico", "cattedrale e centro storico"],
    ],
    image: {
      jpg: "/media/hero-rocca-dei-papi-1600.jpg",
      webp: "/media/hero-rocca-dei-papi-1600.webp",
